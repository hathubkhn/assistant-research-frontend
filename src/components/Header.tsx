...
export default function Header() {
  ...
  const menuItems = [
    {
      key: '/dashboard',
      label: <Link href='/dashboard'>{t('header.dashboard')}</Link>,
    },
    { key: '/papers', label: <Link href='/papers'>{t('header.papers')}</Link> },
    {
      key: '/journals',
      label: <Link href='/journals'>{t('header.journals')}</Link>,
    },
    {
      key: '/conferences',
      label: <Link href='/conferences'>{t('header.conferences')}</Link>,
    },
    {
      key: '/datasets',
      label: <Link href='/datasets'>{t('header.datasets')}</Link>,
    },
    {
      key: '/research-assistant',
      label: (
        <Link href='/research-assistant'>{t('header.researchAssistant')}</Link>
      ),
    },
    {
      key: '/ai-scientist',
      label: <Link href='/ai-scientist'>{t('header.aiScientist')}</Link>,
    },
    {
      key: 'my-library',
      label: (
        <a href='#' onClick={handleMyLibraryClick}>
          {t('header.myLibrary')}
        </a>
      ),
    },
