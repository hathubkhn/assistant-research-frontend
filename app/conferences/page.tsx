...
export default function ConferencesPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-blue-900 mb-6">Academic Conferences</h1>
                                ...
                                {conferences.map((conference) => (
                                    <tr key={conference.id} className="hover:bg-gray-50">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <Link href={`/conferences/${conference.id}`} className="text-blue-600 hover:text-blue-800 hover:underline">
                                                {conference.name}
                                            </Link>
                                        </td>
