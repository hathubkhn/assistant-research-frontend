...
function SignupForm() {
  ...
  const handleDirectSignupChange = (
    e: React.ChangeEvent<
  ...
  const handleDirectSignup = async (e: React.FormEvent) => {
    ...
    const keywords = [
      ...
      ...(directSignupData.custom_keywords
        ? directSignupData.custom_keywords.split(',').map((k) => k.trim())
        : []),
    ].join(', ')
    ...
    try {
      console.log(
        'Making registration API call to:',
      ...
      if (registerResponse.ok) {
        ...
        if (data.token) {
          ...
          console.log(
            'Making profile update API call to:',
          ...
          if (profileResponse.ok) {
            ...
            try {
              ...
              console.error(
                'Could not parse profile update error response:',
                parseError,
              )
            }
          }
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-xs text-gray-500 mt-1'>
                  Auto-generated from your first and last name
                </p>
              </div>
              <div>
                <label
